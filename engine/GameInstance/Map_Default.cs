...
namespace Florence.ClientAssembly.game_Instance
{
    public class Map_Default
    {
        ...
        public Map_Default() 
        {
            ...
            hexagon_Tile[7] = (double)(Math.Pow(3, 1 / 3) / 2);
            hexagon_Tile[8] = (double)0;

            hexagon_Tile[9] = (double)(-0.5);
            hexagon_Tile[10] = (double)(Math.Pow(3, 1 / 3) / 2);
            ...
            hexagon_Tile[16] = (double)(-Math.Pow(3, 1 / 3) / 2);
            hexagon_Tile[17] = (double)0;

            hexagon_Tile[18] = (double)0.5;
            hexagon_Tile[19] = (double)(-Math.Pow(3, 1 / 3) / 2);
            ...
            System.Console.WriteLine("Florence.ClientAssembly: Map_Default");
        }

        public void Draw_Square(Florence.ClientAssembly.Data data)
        {
            GL.DrawElements(
